...
const T = {
  es: {
    ...
    'exp.li1d': 'Implementé automatizaciones con AutoHotkey y AutoCAD para agilizar el etiquetado, la representación de líneas y la preparación de planos.',
    'exp.li2a': 'Ejecuté estudios de Georradar (GPR) en proyectos a lo largo de la República Mexicana.',
    'exp.li2b': 'Integré resultados de GPR con coordenadas y planos georreferenciados para generar entregables técnicos de apoyo a ingeniería, excavación y construcción.',
    'exp.li2c': 'Apoyé la toma de decisiones en obra a partir del análisis de condiciones del subsuelo.',
    'exp.li3a': 'Participé en el diseño estructural y documentación ejecutiva de una nave industrial, incluyendo planos, detalles constructivos, especificaciones y criterios de ingeniería.',
    'exp.li3b': 'Desarrollé análisis estructurales y memorias técnicas para validar elementos de acero estructural y concreto reforzado conforme a los requerimientos del proyecto.',
    'exp.li3c': 'Elaboré y coordiné planos de estructura, arquitectura e instalaciones MEP mediante metodología BIM.',
    'exp.li3d': 'Colaboré en la preparación de documentación técnica para construcción, incluyendo especificaciones, detalles, cuantificaciones y revisiones de constructabilidad.',
  ...
  en: {
    ...
    'exp.li1d': 'Implemented AutoHotkey and AutoCAD automations to streamline labelling, line representation, and drawing preparation.',
    'exp.li2a': 'Performed Ground Penetrating Radar (GPR) surveys on projects across Mexico.',
    'exp.li2b': 'Integrated GPR results with coordinates and georeferenced drawings to produce technical deliverables supporting engineering, excavation, and construction.',
    'exp.li2c': 'Supported on-site decision-making based on subsurface condition analysis.',
    'exp.li3a': 'Participated in the structural design and executive documentation of an industrial warehouse, including drawings, construction details, specifications, and engineering criteria.',
    'exp.li3b': 'Developed structural analyses and technical calculation reports to validate structural steel and/or reinforced concrete elements per project requirements.',
    'exp.li3c': 'Produced and coordinated structural, architectural, and MEP drawings under BIM methodology.',
    'exp.li3d': 'Collaborated on technical construction documentation, including specifications, details, quantity take-offs, and constructability reviews.',
